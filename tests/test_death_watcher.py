...
PLAYER_DEATH_LINE = (
    '{"ts":"2026-01-20T21:12:28.773","event":"PLAYER_DEATH","sub_event":"death",'
...
def test_player_death_suicide_zero_position_does_not_trigger():
    event = dw.parse_death_event(PLAYER_DEATH_ZERO_SUICIDE_LINE, "source")
...
def test_multiple_log_folders_yield_events(tmp_path):
    ...
    file_one.write_text(PLAYER_DEATH_LINE + "\n")
    file_two.write_text(
        '{"ts":"2026-01-20T21:12:28.773","event":"PLAYER_DEATH","sub_event":"death",'
